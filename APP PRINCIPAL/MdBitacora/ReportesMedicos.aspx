<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportesMedicos.aspx.cs" Inherits="MdBitacora_ReportesMedicos" %>
...
<head runat="server">
    ...
    <title>Reporte de Gastos Medicos</title>
</head>
<body>
    <form id="form1" runat="server">
        <div class="jumbotron titulo-cabecera" style="height: 115px;">
            <h2 style="width: 781px; padding-bottom: 20px;">Reporte De Reclamos De Gastos Medicos</h2>
            <header>
