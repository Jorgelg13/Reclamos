<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportesDanios.aspx.cs" Inherits="MdBitacora_ReportesDanios" %>
...
<head runat="server">
    ...
    <title>Reporte de Daños</title>
</head>
<body>
    <form id="form1" runat="server">
        <div class="jumbotron titulo-cabecera" style="height: 115px;">
            <h2 style="width: 781px; padding-bottom: 20px;">Reporte De Reclamos Daños Varios</h2>
            <header>
