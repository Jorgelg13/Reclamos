...
public partial class MdBitacora_CabinaUnity_danios : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int idReclamo = Convert.ToInt32(idRecibido);
        var reclamo = DBReclamos.reclamos_varios.Where(r => r.id == idReclamo).First();

        idRecibido2 = reclamo.id_reg_reclamos_varios.ToString();
        polizaRecibida = reclamo.reg_reclamo_varios.poliza;
