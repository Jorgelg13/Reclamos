<%@ Page Title="" Language="C#" MasterPageFile="~/MdBitacora/CabinaUnity/Consultas.master" AutoEventWireup="true" CodeFile="autos.aspx.cs" Inherits="MdBitacora_CabinaUnity_autos" %>
            ...
            <div class="panel-body">
                ...
                <div class="tab-content ">
                        ...
                        <br />
                          <div class="form-group col-sm-12 col-md-10 col-lg-9">
                           ...
                           <div class="form-group col-sm-12 col-md-2 col-lg-3">
                               ...
                               <asp:DropDownList Enabled="false" CssClass="form-control" ID="ddlestado" Style="width: 100%" Height="34px" runat="server">
                    ...
                    <div role="tabpanel" class="tab-pane" id="llamadas">
                        <div class="scrolling-table-container">
                            <asp:GridView ID="GridLLamadas" runat="server" CssClass="table bs-table table-responsive table-hover" AutoGenerateColumns="False" CellPadding="4" 
                                DataSourceID="SqlDataSourcelogLLamadas" ForeColor="#333333" GridLines="None">
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
