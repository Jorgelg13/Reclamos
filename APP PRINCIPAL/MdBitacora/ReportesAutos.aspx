<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportesAutos.aspx.cs" Inherits="MdBitacora_ReportesAutos" %>
...
<head runat="server">
    ...
    <title>Reporte de Autos</title>
</head>
<body>
    <form id="form1" runat="server">
        <div class="jumbotron titulo-cabecera" style="height: 115px;">
            <h2 style="width: 781px; padding-bottom: 20px;">Reporte De Reclamos Autos</h2>
            <header>
