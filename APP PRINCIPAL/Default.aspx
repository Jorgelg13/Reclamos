        ...
        <div class="col-md-3 col-lg-3" style="height:400px;">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <a href="/Modulos/Dashboard/DashboardCabina.aspx" title="Control de reportes realizados en cabina de llamadas de emergencia" style="font-size: 100px;"><i class="fa fa-phone-square"></i></a>
        ...
        <div class="col-md-3 col-lg-3" style="height:300px;">
         ...
         <div class="col-md-3 col-lg-3" style="height:400px;">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <a href="/Modulos/Dashboard/DashboardNoConforme.aspx" title="Control de Producto no conforme" style="font-size: 100px;"><i class="fa fa-frown-o"></i></a>
                    <p style="text-align: center">
         ...
         <div class="col-md-3 col-lg-3" style="height:400px;">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <a href="#" title="Control de mensajeria" style="font-size: 100px;"><i class="fa fa-envelope-o"></i></a>
                    <p style="text-align: center">
