<%@ Page Title="" Language="C#" MasterPageFile="~/Consultas/Caja-de-ahorro/CajaAhorro.master" AutoEventWireup="true" CodeFile="ReclamosGM.aspx.cs" Inherits="Consultas_Caja_de_ahorro_ReclamosGM" %>
                            ...
                            <div class="panel panel-info col-sm-12 col-md-12 col-lg-12 panel-cuadrado">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group col-md-6 col-lg-3 col-sm-12">
                                        Tipo:
                                        <asp:DropDownList CssClass="form-control" ID="ddlDetalleGasto" Enabled="false" Style="width: 100%" Height="32px" runat="server">
                                    ...
                                    <div class="form-group col-md-6 col-lg-2 col-sm-12">
                                        Cantidad:
                                        <asp:TextBox ID="txtAgregarGasto" Enabled="false" Text="0.00" CssClass="form-control" Style="width: 100%" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-md-6 col-lg-3 col-sm-12">
                                        No. Factura:
                                        <asp:TextBox runat="server" Enabled="false" ID="txtNumFactura" autocomplete="false" Style="width: 100%" placeholder="Numero de factura" class="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-md-6 col-lg-2 col-sm-12">
                                        Fecha de gasto:<asp:TextBox runat="server" Enabled="false" type="date" ID="txtFechaGasto" autocomplete="false" Style="width: 100%; height: 34px;" class="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-md-6 col-lg-1 col-sm-12">
                                        <label style="color: white">Guardar</label>
                                        <asp:LinkButton ID="linkGuardarDetalleGMedico" Visible="false" OnClick="btnguardarDetalle_Click" title="Guardar detalle de gasto medico" runat="server" Style="font-size: 30px; width: 100%;"><i class="fa fa-floppy-o"></i></asp:LinkButton>
                                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane active " id="coberturas">
                            <div class="panel panel-info col-sm-12 col-md-12 col-lg-12 panel-cuadrado">
                                <div class="panel-heading panel-memos">
                                    ...
                                    <asp:CheckBox ID="CheckMemoAseguradora" Enabled="false" AutoPostBack="true" Text="Generar Memo Aseguradora" title="Generar Memo para la aseguradora" runat="server" Style="padding-left: 10%;" OnCheckedChanged="CheckMemoAseguradora_CheckedChanged" />
                                </div>
                                <div class="panel-body">
                                    <div style="height: 170px; overflow-x: auto;">
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6">
                                            <label>Detalle para el cliente:</label>
                                            <asp:TextBox ID="txtdetalle" Enabled="false" Style="width: 100%" autocomplete="off" class="form-control" TextMode="multiline" Columns="50" Rows="3" runat="server" />
                                        </div>
                                        <div class="form-group col-sm-12 col-md-6 col-lg-6">
                                            <label>Observaciones para memo de aseguradora:</label>
                                            <asp:TextBox ID="txtObservaciones" Enabled="false" Style="width: 100%" autocomplete="off" class="form-control" TextMode="multiline" Columns="50" Rows="3" runat="server" />
                                        </div>
                                        <div class="form-group col-sm-12 col-md-4 col-lg-4">
                                            <label>Elegir una direccion:</label>
                                            <asp:DropDownList Enabled="false" CssClass="form-control" ID="ddlDirecciones" Style="width: 97%; height: 32px;" runat="server"></asp:DropDownList>
                                        </div>
                                        <div class="form-group col-sm-12 col-md-4 col-lg-4">
                                            <label>Direccion Manual:</label>
                                            <asp:TextBox ID="txtDireccion" Enabled="false" Style="width: 95%" autocomplete="off" class="form-control" placeholder="Si no existe la direccion puede escribirla aqui" runat="server" />
                                        </div>
                                        <div class="form-group col-sm-12 col-md-4 col-lg-4">
                                            <label>Ejecutivo:</label>
                                            <asp:TextBox ID="txtEjecutivo" Enabled="false" Style="width: 95%" class="form-control" placeholder="Nombre de ejecutivo para memos" runat="server" />
                                        </div>
                                        <div class="form-group col-sm-12 col-md-4 col-lg-4">
                ...
                <div class="panel-body">
                    <div class="btn-acciones-laterales2">
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <a role="button"><i class="fa fa-print"></i></a>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <a role="button" ><i class="fa fa-envelope-o"></i></a>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <a  role="button"><i class="fa fa-pencil-square-o"></i></a>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <a role="button"><i class="fa fa-money"></i></a>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <asp:LinkButton ID="btnGuardar" role="button" OnClick="btnActualizar_Click" title="Actualizar Informacion" Enabled="false" runat="server"><i class="fa fa-floppy-o"></i></asp:LinkButton>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <a  role="button" data-toggle="modal"><i class="fa fa-paper-plane"></i></a>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <a role="button" data-toggle="modal"><i class="fa fa-users"></i></a>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-2 col-lg-3">
                            <a  role="button"><i class="fa fa-calendar-check-o"></i></a>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <a role="button"><i class="fa fa-comments"></i></a>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <a role="button" style="color: red"><i class="fa fa-frown-o"></i></a>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <a role="button"><i class="fa fa-file-pdf-o"></i></a>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <a role="button"><i class="fa fa-search"></i></a>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <asp:LinkButton ID="linkRegresar" role="button" OnClick="Regresar_Click" title="Regresar a Inicio" runat="server"><i class="fa fa-arrow-left"></i></asp:LinkButton>
                        </div>
                        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-3">
                            <a role="button"><i class="fa fa-lock" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                <div class="panel-body">
                    <div class="form-group col-sm-12 col-md-12 col-lg-12">
                        ...
                        <asp:TextBox Enabled="false" runat="server" ID="txtAsegurado" autocomplete="false" Style="width: 100%" class="form-control" placeholder="Asegurado"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-12 col-md-12 col-lg-12">
                        <label>Aseguradora:</label>
                        <asp:TextBox Enabled="false" runat="server" ID="txtAseguradora" autocomplete="false" Style="width: 100%" class="form-control" placeholder="Aseguradora"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
                        <label>Poliza:</label>
                        <asp:TextBox Enabled="false" runat="server" ID="txtPoliza" autocomplete="false" Style="width: 100%" class="form-control" placeholder="Poliza"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
                        <label>Telefono:</label>
                        <asp:TextBox Enabled="false" runat="server" ID="txtTelefono" autocomplete="false" Style="width: 100%" class="form-control" placeholder="Telefono"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-12 col-md-12 col-lg-12">
                        <label>Correo:</label>
                        <asp:TextBox runat="server" Enabled="false" ID="txtCorreo" autocomplete="false" Style="width: 100%" class="form-control" placeholder="Correo"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
                        <label>Tipo Reclamo:</label>
                        <asp:DropDownList Enabled="false" CssClass="form-control" ID="DDLTipo" Style="width: 100%" Height="34px" runat="server">
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
                        <label>Estado:</label>
                        <asp:DropDownList Enabled="false" CssClass="form-control" ID="ddlEstado" AutoPostBack="true" OnSelectedIndexChanged="ddlEstado_SelectedIndexChanged" Style="width: 100%" Height="34px" runat="server">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentJs" runat="Server">
    ...
    <script> 
        var id = $('#lblIdOculto').text();
        var ruta = $('#lblDocumento').text();
        function Scaner() {
