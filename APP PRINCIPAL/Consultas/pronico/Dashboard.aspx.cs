...
public partial class Consultas_Caja_de_ahorro_Dashboard : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        " where reg_reclamos_medicos.poliza in('SC-1291','SC-1288','SC-1289','SC-1290') and reclamos_medicos.estado_unity = 'Seguimiento'";
    ...
    public void conteo()
    {
        ...
        string totalrm = " select count(*) " +
            "from reclamos_medicos as r " +
            "inner join reg_reclamos_medicos as reg on r.id_reg_reclamos_medicos = reg.id " +
            " where reg.poliza in('SC-1291','SC-1288','SC-1289','SC-1290') " +
            " and r.estado_unity = 'Seguimiento'";
    ...
    {
        Response.Redirect("/Consultas/pronico/ReportesMedicos.aspx");
    }
}