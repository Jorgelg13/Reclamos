<%@ Page Title="" Language="C#" MasterPageFile="~/Consultas/Caja-de-ahorro/CajaAhorro.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Dashboard.aspx.cs" Inherits="Consultas_Caja_de_ahorro_Dashboard" %>
        ...
        <div class="container menu-cuadrado btn-acciones-laterales">
            ...
            <div class="col-md-3 col-lg-3" style="height: 190px;">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <h1>
                            <a href="/Consultas/Caja-de-ahorro/ConsultarAsegurados.aspx" title="Consultar Asegurados" style="font-size: 60px;" class="fa fa-users"></a>
                            <br />
                            <br />
                        </h1>
                    </div>
