...
public partial class Consultas_Tigo_Dashboard : System.Web.UI.Page
{
    String Pendientes;
    ...
    protected void GridGeneral_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("/Consultas/Tigo/ReclamosAutos.aspx",false);
    }
    ...
    protected void GridMedicos_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("/Consultas/Tigo/ReclamosGM.aspx", false);
    }
    ...
    {
        Response.Redirect("/Consultas/Tigo/ReportesAutos.aspx");
    }

    protected void ReportesMedicos_Click(object sender, EventArgs e)
    {
        Response.Redirect("/Consultas/Tigo/ReportesMedicos.aspx");
    }
}