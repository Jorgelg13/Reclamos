...
public partial class Consultas_Tigo_ReclamosGM : System.Web.UI.Page
{
    ...
    {
        idRecibido = Session["id_rm_caja"].ToString();
    ...
    {
        actualizarReclamo();
        Response.Redirect("/Consultas/Tigo/Dashboard.aspx", false);
    }
