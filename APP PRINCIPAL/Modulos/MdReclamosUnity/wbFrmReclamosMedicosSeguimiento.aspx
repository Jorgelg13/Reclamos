            ...
            <div class="panel-body" style="height: auto; padding: 0px;">
                ...
                <ul class="nav nav-tabs margen " role="tablist">
                    <li role="presentation" class="home">
                        <a href="#home" aria-controls="messages" role="tab" data-toggle="tab">Detalle</a>
                    </li>
                    ...
                    <li role="presentation" class="profile">
                        <a href="#profile" aria-controls="llamadas" role="tab" data-toggle="tab">Boleta</a>
                    </li>
                    <li role="presentation" class="ingreso-datos">
                        <a href="#ingreso-datos" aria-controls="llamadas" role="tab" data-toggle="tab">Tiempo</a>
                    </li>
                </ul>
                    ...
                    <div role="tabpanel" class="tab-pane active " id="coberturas">
                        ...
                        <div class="panel panel-info col-sm-12 col-md-12 col-lg-12 panel-cuadrado">
                            ...
                            <div class="panel-body">
                                <div style="height: auto; overflow-x: auto;">
                                    <asp:GridView ID="GridPagos" runat="server" CssClass="table bs-table tablaDetalleAuto table-responsive" AutoGenerateColumns="True" OnSelectedIndexChanged="GridPagos_SelectedIndexChanged">
                                        <Columns>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-sm-12 col-md-4 col-lg-4">
                        <label>Banco:</label>
                        <asp:DropDownList CssClass="form-control" ID="ddlBanco" Style="width: 100%" Height="30px" runat="server">
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
                        ...
                        <asp:DropDownList CssClass="form-control" ID="ddlCoaseguro" Style="width: 100%" Height="30px" runat="server">
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
                        <label>Timbres:</label>
                        <asp:DropDownList CssClass="form-control" ID="ddlTimbres" Style="width: 100%" Height="30px" runat="server">
