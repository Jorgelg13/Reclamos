...
<%--                                    <div id="dwtcontrolContainer"></div>
                                    ...
                                    <label>pdf<input type="radio" value="pdf" name="ImageType" id="imgTypetiff"></label>
                            ...
                            <div class="panel panel-info col-sm-12 col-md-12 col-lg-12 panel-cuadrado">
                                ...
                                <div class="panel-body">
                                    <div style="height: 170px; overflow-x: auto;">
                                        ...
                                        <div class="form-group col-sm-12 col-md-4 col-lg-4">
                                            <label for="message-text" class="control-label">Contacto:</label>
    ...
    <div class="btn-acciones-laterales">
        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-1">
            <div class="panel panel-info">
                <div class="panel-heading">
                </div>
                <div class="panel-body">
                    <a onclick="printDiv('imprimir')" title="Imprimir El Formulario de documentos" style="font-size: 40px;"><i class="fa fa-print" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-1">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <a data-toggle="modal" title="Enviar un correo electronico" data-target="#exampleModal" style="font-size: 40px;"><i class="fa fa-envelope-o" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-1">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <a title="Agregar un comentario" data-toggle="modal" data-target="#ModalComentario" style="font-size: 40px;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-1">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <a title="Realizar Liquidacion" data-toggle="modal" data-target="#modalPago" style="font-size: 40px; text-align: center;"><i class="fa fa-money" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-1">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <asp:LinkButton ID="btnGuardar" OnClick="btnActualizar_Click" title="Actualizar Informacion" runat="server" Style="font-size: 40px; text-align: center;"><i class="fa fa-floppy-o" aria-hidden="true"></i></asp:LinkButton>
                </div>
            </div>
        </div>
        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-1">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <a onclick="printDiv('imprimirEnvioAseg')" title="Imprimir Memo a la aseguradora" data-toggle="modal" style="font-size: 40px; text-align: center;"><i class="fa fa-paper-plane" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-1">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <a onclick="printDiv('imprimirEnvioCliente')" title="Imprimir Memo al cliente" data-toggle="modal" style="font-size: 40px; text-align: center;"><i class="fa fa-users" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <div class="col-xs-3 col-md-3 col-sm-2 col-lg-1">
            <div class="panel panel-info">
                <div class="panel-heading">
                </div>
                <div class="panel-body">
                    <a title="Proxima fecha a mostrar" data-toggle="modal" data-target="#ModalProximaFecha" style="font-size: 40px; text-align: center;"><i class="fa fa-calendar-check-o" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-1">
         ...
         <div class="col-xs-3 col-md-3 col-sm-4 col-lg-1">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <a title="Enviar Notificacion por falta de documentos" data-toggle="modal" data-placement="left" data-target="#confirmar-sms" style="font-size: 40px; text-align: center;"><i class="fa fa-comments" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
         <div class="col-xs-3 col-md-3 col-sm-4 col-lg-1">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                   <a title="Producto No Conforme" role="button" data-toggle="modal" data-target="#ModalNoconforme" style="font-size: 40px; text-align: center; color:red"><i class="fa fa-frown-o" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <div class="col-xs-3 col-md-3 col-sm-4 col-lg-1">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <a title="Cerrar El Reclamo" data-toggle="modal" data-placement="left" data-target="#CierreReclamo" style="font-size: 40px; text-align: center;"><i class="fa fa-lock" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade bs-example-modal-sm" id="ModalProximaFecha" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
       ...
       <%-- modal para notificacion de sms --%>
        <div class="modal fade bs-example-modal-sm" tabindex="-1" id="confirmar-sms" role="dialog" aria-labelledby="mySmallModalLabel">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
