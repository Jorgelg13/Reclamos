<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Renovaciones.master" AutoEventWireup="true" CodeFile="cambiar-usuario.aspx.cs" Inherits="Modulos_MdRenovaciones_Catalogo_cambiar_usuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="panel panel-info">
            <div class="panel-heading"><b>Reasignar Usuario</b></div>
            <div class="panel-body">
                ...
                <div class="form-group  col-sm-12 col-md-6 col-lg-2" style="padding-top: 10px;">
                    <label>Usuario:</label>
                    <asp:DropDownList runat="server" ID="ddlUsuario" CssClass="form-control" Width="100%">
                    </asp:DropDownList>
                </div>
                    ...
                    <asp:GridView ID="GridPolizas" CssClass="table bs-table table-responsive" runat="server" AutoGenerateColumns="True" ForeColor="#333333" GridLines="None">
                        <Columns>
                            <asp:TemplateField HeaderText="Seleccionar">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chCambiarUsuario" runat="server" Text="Cambiar"/>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
    ...
    <div id="container-floating">
        ...
        <div class="nd1 nds" data-toggle="tooltip" data-placement="left" data-original-title="Edoardo@live.it">
            <asp:LinkButton ID="btnGuardarCambios" OnClick="btnGuardarCambios_Click" title="Guardar" CssClass="letter" autopostback="true" runat="server"><i class="fa fa-save"></i></asp:LinkButton>
        </div>
