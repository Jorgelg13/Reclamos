                        ...
                        <div style="height: 600px;">
                            <div class="table-container" style="overflow-y: auto;">
                                <div id="ciclos" class="col-sm-12 col-md-12 col-lg-4">
                                    <b>Asignaciones</b>
                                    <asp:GridView ID="GridAsignaciones" runat="server" CssClass="table bs-table table-responsive" OnRowDataBound="GridAsignaciones_RowDataBound" 
                                    ...
                                    <asp:GridView ID="GridReclamosPorEstado" runat="server" CssClass="table bs-table table-responsive" OnRowDataBound="GridReclamosPorEstado_RowDataBound" 
                                         AutoGenerateColumns="True" ShowFooter="true" ForeColor="#333333" GridLines="None">
                                         <AlternatingRowStyle BackColor="White" />
                                         <FooterStyle BackColor="#48086f" Font-Bold="True" ForeColor="White" />
                                         <HeaderStyle BackColor="#48086f" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" Wrap="False" />
                                ...
                                <div id="ciclos2" class="col-sm-12 col-md-6 col-lg-8">
                                    ...
                                    <asp:GridView ID="GridPendientes" runat="server" CssClass="table bs-table table-responsive" OnRowDataBound="GridPendientes_RowDataBound" 
                                        AutoGenerateColumns="True" ShowFooter="true" ForeColor="#333333" GridLines="None">
                                        <AlternatingRowStyle BackColor="White" />
                                        <FooterStyle BackColor="#48086f" Font-Bold="True" ForeColor="White" />
                                        <HeaderStyle BackColor="#48086f" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" Wrap="False" />
                                    ...
                                    <br />
                                      <b>Reclamos asignados sin aperturar</b>
                                      <asp:GridView ID="GridReclamosSinAperturar" runat="server" CssClass="table bs-table table-responsive" 
