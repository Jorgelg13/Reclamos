                        ...
                        <asp:Panel runat="server" ID="PanelEficiencia">
                            <div class="scrolling-table-container">
                                <asp:GridView ID="GridEficiencia" runat="server" CssClass="table bs-table table-responsive" AutoGenerateColumns="True" ForeColor="#333333" GridLines="None" OnRowDataBound="GridEficiencia_RowDataBound" ShowFooter="true">
                                    ...
                                    <HeaderStyle BackColor="#48086f" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" Wrap="True" />
                                    <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
...
<asp:Content runat="server" ContentPlaceHolderID="ContentJs" ID="JS">
    ...
    <script>
        if ($('#ContentPlaceHolder1_ddlCiclos option:selected').text() == 'Ciclo Unity' || $('#ContentPlaceHolder1_ddlCiclos option:selected').text() == 'Ciclo Aseguradora' ||
            $('#ContentPlaceHolder1_ddlCiclos option:selected').text() == 'Ciclo Cliente' || $('#ContentPlaceHolder1_ddlCiclos option:selected').text() == 'Ciclo Total') {
