<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ReporteAutorizacions.aspx.cs" Inherits="Modulos_MdReportes_ReporteAutorizacions" %>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body" style="padding: 6px;">
                    ...
                    <div class="scrolling-table-container" id="Reporte">
                        <asp:GridView ID="GridAutorizaciones" runat="server" CssClass="table bs-table table-responsive table-hover" AutoGenerateColumns="true" CellPadding="4" ForeColor="#333333" GridLines="None">
