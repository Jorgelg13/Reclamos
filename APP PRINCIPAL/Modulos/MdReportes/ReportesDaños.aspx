<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ReportesDaños.aspx.cs" Inherits="ReportesDaños" %>
     ...
     <form id="form1" runat="server">
        <div class="container-fluid">
            <div class="panel panel-info">
                <div class="panel-heading"><b>Reporte De Daños Varios</b></div>
                <div class="panel-body" style="padding:6px;">
                    ...
                    <div class="scrolling-table-container">
                        <asp:GridView ID="Gridvarios" runat="server" CssClass="table bs-table table-responsive table-hover" AutoGenerateColumns="true" CellPadding="4" ForeColor="#333333" GridLines="None">
