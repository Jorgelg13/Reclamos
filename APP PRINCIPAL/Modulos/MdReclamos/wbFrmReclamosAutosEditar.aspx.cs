...
public partial class Modulos_MdReclamos_wbFrmReclamosAutosEditar : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
         ...
         idRecibido2 = Request.QueryString[1].ToString();
         placaRecibida = Request.QueryString[2].ToString();
