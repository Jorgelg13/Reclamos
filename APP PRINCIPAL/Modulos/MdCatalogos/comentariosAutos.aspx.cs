...
public partial class Modulos_MdCatalogos_comentariosAutos : System.Web.UI.Page
{
    ...
    {
        llenado.llenarGrid("select id, descripcion as Descripcion,usuario as Usuario,fecha as Fecha from comentarios_reclamos_autos where id_reclamo_auto= " + txtbuscar.Text + " order by id desc", gridComentarios);
    ...
    protected void btnGuardarComentario_Click(object sender, EventArgs e)
    {
        ...
        var reclamo = DBReclamos.comentarios_reclamos_autos.Find(id);
    ...
    protected void btnEliminar_Click(object sender, EventArgs e)
    {
        id = Convert.ToInt32(gridComentarios.SelectedRow.Cells[1].Text);
        var reclamo = DBReclamos.comentarios_reclamos_autos.Find(id);
        DBReclamos.comentarios_reclamos_autos.Remove(reclamo);
        DBReclamos.SaveChanges();
        consulta();
